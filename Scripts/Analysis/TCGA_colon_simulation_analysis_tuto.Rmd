...
High EMT patients are more prone to relapse/death (close to statitically significant). But Migration have pro-survival effects which should encourage us to review its definition and the logical rules defining it.
