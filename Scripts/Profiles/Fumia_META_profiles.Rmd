...
if (nrow(incons)==0){
  print("No mutations/RNA binary inconsistencies")
}else{
  kable(incons)
}
...
write.csv(inverse_mapping(METAmodel_mut_prof),"Results/Profiles/Fumia_META_mutations.csv")

write.csv(inverse_mapping(METAmodel_CNA_prof),"Results/Profiles/Fumia_META_CNA.csv")

write.csv(inverse_mapping(METAmodel_mutCNA_prof),"Results/Profiles/Fumia_META_mutCNA.csv")
write.csv(inverse_mapping(METAmodel_mutCNAneg_prof),"Results/Profiles/Fumia_META_mutCNAneg.csv")

write.csv(inverse_mapping(METAmodel_RNA_prof),"Results/Profiles/Fumia_META_RNA.csv")
write.csv(inverse_mapping(METAmodel_RNA_prof_norm, datatype='norm'),"Results/Profiles/Fumia_META_RNA_norm.csv")

write.csv(inverse_mapping(METAmodel_mutRNA_prof),"Results/Profiles/Fumia_META_mutRNA.csv")
