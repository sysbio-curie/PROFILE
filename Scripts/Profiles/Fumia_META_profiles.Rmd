...
METAmodel_mutCNA_prof = METAmodel_mutCNAneg_prof <- matrix(nrow = length(common_patients), ncol = length(concerned_genes), dimnames = list(common_patients,concerned_genes)) %>% as.data.frame
...
for(gene in concerned_genes){
  if (gene %in% colnames(METAmodel_mut_prof) & gene %in% colnames(METAmodel_CNA_prof)){
    ...
    METAmodel_mutCNAneg_prof[,gene] <- mut_plus_CNA(METAmodel_mut_prof[common_patients,gene], METAmodel_CNAneg_prof[common_patients,gene])
  } else if (gene %in% colnames(METAmodel_CNA_prof)) {
    METAmodel_mutCNA_prof[,gene] <- METAmodel_CNA_prof[common_patients,gene]
    METAmodel_mutCNAneg_prof[,gene] <- METAmodel_CNAneg_prof[common_patients,gene]
  } else {
    METAmodel_mutCNA_prof[,gene] <- METAmodel_mut_prof[common_patients,gene]
    METAmodel_mutCNAneg_prof[,gene] <- METAmodel_mut_prof[common_patients,gene]
  }
}
