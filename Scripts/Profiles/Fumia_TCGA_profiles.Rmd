...
TCGAmodel_mutCNA_prof = TCGAmodel_mutCNAneg_prof <- matrix(nrow = length(common_patients_MCR), ncol = dim(TCGAmodel_CNA_prof)[2], dimnames = list(common_patients_MCR,colnames(TCGAmodel_CNA_prof))) %>% as.data.frame
TCGAmodel_CNAneg_prof <- TCGAmodel_CNA_prof
TCGAmodel_CNAneg_prof[TCGAmodel_CNAneg_prof==1] <- NA

for(i in 1:dim(TCGAmodel_mutCNA_prof)[2]){
  gene <- colnames(TCGAmodel_mutCNA_prof)[i]
  if (gene %in% colnames(TCGAmodel_mut_prof)){
    TCGAmodel_mutCNA_prof[,gene] <- mut_plus_CNA(TCGAmodel_mut_prof[common_patients_MCR,gene], TCGAmodel_CNA_prof[common_patients_MCR,gene])
    TCGAmodel_mutCNAneg_prof[,gene] <- mut_plus_CNA(TCGAmodel_mut_prof[common_patients_MCR,gene], TCGAmodel_CNAneg_prof[common_patients_MCR,gene])
  } else {
    TCGAmodel_mutCNA_prof[,gene] <- TCGAmodel_CNA_prof[common_patients_MCR,gene]
    TCGAmodel_mutCNAneg_prof[,gene] <- TCGAmodel_CNAneg_prof[common_patients_MCR,gene]
  }
}
...
TCGAmodel_mutCNA_prof <- matrix(nrow = length(common_patients_MCR), ncol = dim(TCGAmodel_CNA_prof)[2], dimnames = list(common_patients_MCR,colnames(TCGAmodel_CNA_prof))) %>% as.data.frame
...
write.csv(inverse_mapping(TCGAmodel_mut_prof),"Results/Profiles/Fumia_TCGA_mutations.csv")

write.csv(inverse_mapping(TCGAmodel_CNA_prof),"Results/Profiles/Fumia_TCGA_CNA.csv")

write.csv(inverse_mapping(TCGAmodel_mutCNA_prof),"Results/Profiles/Fumia_TCGA_mutCNA.csv")
write.csv(inverse_mapping(TCGAmodel_mutCNAneg_prof),"Results/Profiles/Fumia_TCGA_mutCNAneg.csv")

write.csv(inverse_mapping(TCGAmodel_RNA_prof),"Results/Profiles/Fumia_TCGA_RNA.csv")
write.csv(inverse_mapping(TCGAmodel_RNAref_prof),"Results/Profiles/Fumia_TCGA_RNAref.csv")
write.csv(inverse_mapping(TCGAmodel_RNA_prof_norm, datatype='norm'),"Results/Profiles/Fumia_TCGA_RNA_norm.csv")
write.csv(inverse_mapping(TCGAmodel_RNAref_prof_norm, datatype='norm'),"Results/Profiles/Fumia_TCGA_RNAref_norm.csv")

write.csv(inverse_mapping(TCGAmodel_prot_prof),"Results/Profiles/Fumia_TCGA_prot.csv")
write.csv(inverse_mapping(TCGAmodel_prot_prof_norm, datatype='norm'),"Results/Profiles/Fumia_TCGA_prot_norm.csv")

write.csv(inverse_mapping(TCGAmodel_exp_prof),"Results/Profiles/Fumia_TCGA_exp.csv")
write.csv(inverse_mapping(TCGAmodel_expref_prof),"Results/Profiles/Fumia_TCGA_expref.csv")
write.csv(inverse_mapping(TCGAmodel_exp_prof_norm, datatype='norm'),"Results/Profiles/Fumia_TCGA_exp_norm.csv")
write.csv(inverse_mapping(TCGAmodel_expref_prof_norm, datatype='norm'),"Results/Profiles/Fumia_TCGA_expref_norm.csv")

write.csv(inverse_mapping(TCGAmodel_mutexp_prof),"Results/Profiles/Fumia_TCGA_mutexp.csv")
write.csv(inverse_mapping(TCGAmodel_mutexpref_prof),"Results/Profiles/Fumia_TCGA_mutexpref.csv")
write.csv(inverse_mapping(TCGAmodel_mutRNA_prof),"Results/Profiles/Fumia_TCGA_mutRNA.csv")
write.csv(inverse_mapping(TCGAmodel_mutRNAref_prof),"Results/Profiles/Fumia_TCGA_mutRNAref.csv")
write.csv(inverse_mapping(TCGAmodel_mutprot_prof),"Results/Profiles/Fumia_TCGA_mutprot.csv")
