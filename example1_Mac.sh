...
python3 Scripts/Simulations/MaBoSS_specific_Mac.py $model -n 98 -p 3 "Results/Simulations/results_"$sim_case".txt" -s $sim_case -m "Results/Profiles/Fumia_META_mutCNA.csv" 
